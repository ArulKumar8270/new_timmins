...
(function ($) {
  ...
  // Helper function to initialize sliders with retry mechanism for Next.js
  function initSliders(retryCount = 0) {
    const maxRetries = 10;
    ...
    function tryInitSliders() {
      /*======================================================================================
        Hero Slider JS
      =======================================================================================*/
      if (typeof $ !== 'undefined' && typeof $.fn !== 'undefined' && typeof $.fn.owlCarousel !== 'undefined' && $(".ed-hero__slider").length > 0) {
        if (!$(".ed-hero__slider").hasClass("owl-loaded")) {
          try {
      ...
      /*======================================================================================
        Partner Slider JS
      =======================================================================================*/
      if (typeof $ !== 'undefined' && typeof $.fn !== 'undefined' && typeof $.fn.owlCarousel !== 'undefined' && $(".ed-partner__slider").length > 0) {
        if (!$(".ed-partner__slider").hasClass("owl-loaded")) {
          try {
      ...
      =======================================================================================*/
      const partnerSlider2El = document.querySelector(".ed-partner__slider-2");
      if (typeof Swiper !== 'undefined' && partnerSlider2El && !partnerSlider2El.classList.contains('swiper-initialized')) {
        const clientSliderTwo = new Swiper(partnerSlider2El, {
          slidesPerView: 1,
          loop: true,
          speed: 5000,
          autoplay: {
      ...
      =======================================================================================*/
      const partnerSlider3El = document.querySelector(".ed-partner__slider-2-reverse");
      if (typeof Swiper !== 'undefined' && partnerSlider3El && !partnerSlider3El.classList.contains('swiper-initialized')) {
        const clientSliderThree = new Swiper(partnerSlider3El, {
          slidesPerView: 1,
          loop: true,
          speed: 5000,
          autoplay: {
      ...
      =======================================================================================*/
      if (typeof $ !== 'undefined' && typeof $.fn !== 'undefined' && typeof $.fn.owlCarousel !== 'undefined' && $(".ed-testimonial__slider").length > 0) {
        if (!$(".ed-testimonial__slider").hasClass("owl-loaded")) {
          try {
      ...
      =======================================================================================*/
      const testimonialSlider2El = document.querySelector(".ed-testimonial__slider-2");
      if (typeof Swiper !== 'undefined' && testimonialSlider2El && !testimonialSlider2El.classList.contains('swiper-initialized')) {
        const testimonialSliderTwo = new Swiper(testimonialSlider2El, {
          slidesPerView: 1,
          spaceBetween: 30,
          autoplay: {
            delay: 5000,
      ...
      =======================================================================================*/
      const testimonialSlider3El = document.querySelector(".ed-testimonial__slider-3");
      if (typeof Swiper !== 'undefined' && testimonialSlider3El && !testimonialSlider3El.classList.contains('swiper-initialized')) {
        const testimonialSliderThree = new Swiper(testimonialSlider3El, {
          slidesPerView: 3,
          spaceBetween: 30,
          loop: true,
          navigation: {
      ...
      /*======================================================================================
        Category Slider JS
      =======================================================================================*/
      const categorySliderEl = document.querySelector(".ed-category__slider");
      if (typeof Swiper !== 'undefined' && categorySliderEl && !categorySliderEl.classList.contains('swiper-initialized')) {
        const categorySlider = new Swiper(categorySliderEl, {
          slidesPerView: 3,
          spaceBetween: 30,
          autoplay: {
            delay: 5000,
  ...
  // Fallback: Also try to initialize sliders when window loads (for Next.js)
  if (document.readyState === 'complete') {
    // Page already loaded, try initializing immediately
    setTimeout(function() {
      initSliders();
    }, 500);
  } else {
...
(function() {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initElementMove);
  } else {
    initElementMove();
  }
})();
